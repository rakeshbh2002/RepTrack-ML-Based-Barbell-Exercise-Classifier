...
outlier_cloumn=list(df.columns[:6])
# --------------------------------------------------------------
# Plotting outliers
# --------------------------------------------------------------
...
df[outlier_cloumn[:3]+["label"]].boxplot(by="label", figsize=(20,10),layout=(1,3))
df[outlier_cloumn[:3]+["label"]].boxplot(by="label", figsize=(20,10),layout=(1,3))
...
df[outlier_cloumn[:3]+["label"]].plot.hist(by="label", figsize=(20,20),layout=(3,3))
df[outlier_cloumn[:3]+["label"]].plot.hist(by="label", figsize=(20,20),layout=(3,3))
...
dataset, outliers, X_scores = mark_outliers_lof(df, outlier_cloumn)
for col in outlier_cloumn:
...
dataset, outliers, X_scores = mark_outliers_lof(df[df["label"]==label], outlier_cloumn)
for col in outlier_cloumn:
    plot_binary_outliers(dataset=dataset,col=col,outlier_col="outlier_lof", reset_index=True ) 
